...
class LoadMotor:
    ...
    def __init__(self) -> None:
        self.d: Optional[float] = None  # Damping factor (D). Unit = delta P/delta speed. Typical Value = 2.
        self.h: Optional[float] = None  # Inertia constant (H) (not=0). Typical Value = 0.4.
        self.lfac: Optional[float] = None  # Loading factor - ratio of initial P to motor MVA base (Lfac). Typical Value = 0.8.
        self.lp: Optional[float] = None  # Transient reactance (Lp). Typical Value = 0.15.
        self.lpp: Optional[float] = None  # Subtransient reactance (Lpp). Typical Value = 0.15.
        self.ls: Optional[float] = None  # Synchronous reactance (Ls). Typical Value = 3.2.
        self.pfrac: Optional[float] = None  # Fraction of constant-power load to be represented by this motor model (Pfrac) (>=0.0 and <=1.0). Typical Value = 0.3.
        self.ra: Optional[float] = None  # Stator resistance (Ra). Typical Value = 0.
        self.tbkr: Optional[float] = None  # Circuit breaker operating time (Tbkr). Typical Value = 0.08.
        self.tpo: Optional[float] = None  # Transient rotor time constant (Tpo) (not=0). Typical Value = 1.
        self.tppo: Optional[float] = None  # Subtransient rotor time constant (Tppo). Typical Value = 0.02.
        self.tv: Optional[float] = None  # Voltage trip pickup time (Tv). Typical Value = 0.1.
        self.vt: Optional[float] = None  # Voltage threshold for tripping (Vt). Typical Value = 0.7.
        self.load_aggregate: Optional[LoadAggregate] = None  # Aggregate load to which this aggregate motor (dynamic) load belongs.
