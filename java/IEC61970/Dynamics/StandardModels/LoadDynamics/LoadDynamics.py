...
from IEC61970.Dynamics.StandardModels.LoadDynamics import IdentifiedObject
...
class LoadDynamics(IdentifiedObject):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.energy_consumer: Any  # Energy consumer to which this dynamics load model applies
