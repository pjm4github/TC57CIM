 ...
 */
public enum OilAnalysisFluidAnalogKind {
	/**
	...
	additiveDBDS,
	/**
	 * Specific gravity corrected to 15øC. Also known as relative density. It is a
	...
	density,
	/**
	 * Fire point (in øC). Fire point is when fire is sustained (oil catches fire).
	 * Can only be done by means of open cup test, which is commonly used in US.
	 */
	firePoint,
	/**
	 * Flash point (in øC) determined via open cup test. Flash point occurs when
	 * enough vapors have accumulated to sustain a flash. Open cup is used in US.
	 */
	flashPointOpenCup,
	/**
	 * Flash point (in øC) determined via closed cup test. Flash point occurs when
	 * enough vapors have accumulated to sustain a flash. Closed cup is used in Europe.
	 */
	flashPointClosedCup,
	/**
	 * Pour point (in øC). The pour point of a liquid is the temperature at which it
	 * becomes semi solid and loses its flow characteristics.
	 */
	pourPoint,
	/**
	 * Pour point (in øC) determined by automatic method. The pour point of a liquid
	...
	/**
	 * Resistivity at 90øC (in gigohm-metre).
	 */
	resistivity,
	/**
