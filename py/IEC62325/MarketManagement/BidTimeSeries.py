...
class BidTimeSeries(TimeSeries):
    ...
    def __init__(self):
        ...
        self.minimum_activation_quantity = 0  # The minimum quantity of energy that can be activated at a given time
        # interval.
        self.priority = int()  # The numeric local priority given to a bid.
        self.status = str()  # The information about the status of the bid.
        self.step_increment_quantity = 0  # The minimum increment that can be applied for an increase in an
        # activation request.
