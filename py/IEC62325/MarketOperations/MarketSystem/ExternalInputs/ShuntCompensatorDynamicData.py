...
class ShuntCompensatorDynamicData:
    ...
    def __init__(self) -> None:
        ...
        self.desired_voltage: float = 0.0  # The desired voltage for the Voltage Control Capacitor
        self.mVar_injection: float = 0.0  # The injection of reactive power of the filter bank in the NA solution or VCS reactive power production
        self.step_position: Optional[int] = 0  # Voltage control capacitor step position
        self.voltage_regulation_status: bool = False  # Indicator if the voltage control this is regulating True = Yes, False = No
