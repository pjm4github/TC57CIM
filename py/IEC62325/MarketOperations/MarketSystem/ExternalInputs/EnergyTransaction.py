...
class EnergyTransaction:
    ...
    def __init__(self) -> None:
        self.capacity_backed: Optional[bool] = False  # Interchange capacity flag
        ...
        self.firm_interchange_flag: Optional[bool] = False  # Firm interchange flag indicates whether or not this energy transaction can be changed without potential financial consequences
        self.pay_congestion: Optional[bool] = False  # Willing to Pay congestion flag
        ...
        self.state: Optional[EnergyTransactionType] = EnergyTransactionType()  # { Approve | Deny | Study }
        ...
        self.energy_product: Optional[EnergyProduct] = EnergyProduct()  # The "Source" for an EnergyTransaction is an EnergyProduct which is injected into a ControlArea. Typically this is a ServicePoint
        self.energy_profiles: Optional[EnergyProfile] = EnergyProfile()  # An EnergyTransaction shall have at least one EnergyProfile
        self.curtailment_profiles: Optional[CurtailmentProfile] = CurtailmentProfile()  # An EnergyTransaction may be curtailed by any of the participating entities
