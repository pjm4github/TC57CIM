...
class BidSelfSched:
    ...
    def __init__(self) -> None:
        ...
        self.pump_self_sched_mwOptional[float] = 0.0  # Contains the PriceTaker, ExistingTransmissionContract, TransmissionOwnershipRights pumping self-schedule quantity. If this value is not null, then the unit is in pumping mode.
        self.reference_typeOptional[str] = ""  # Indication of which type of self-schedule is being referenced.
        self.self_sched_mwOptional[float] = 0.0  # Self scheduled value
