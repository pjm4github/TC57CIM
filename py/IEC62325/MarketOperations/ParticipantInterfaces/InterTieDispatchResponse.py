...
class InterTieDispatchResponse:
    ...
    def __init__(self) -> None:
        ...
        """
        self.accept_mw: float = 0.0  # The accepted mw amount by the responder. aka response mw.
        self.accept_status: Optional[DispatchResponseType] = DispatchResponseType.ACCEPT  # The accept status submitted by the responder.
        self.cleared_mw: float = 0.0  # MW amount associated with instruction.
        self.pass_indicator: Optional[PassIndicatorType] = PassIndicatorType.RTPD
