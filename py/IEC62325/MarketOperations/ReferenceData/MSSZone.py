...
class MssZone(AggregateNode):
    ...
    def __init__(self) -> None:
        ...
        self.loss_factor: Optional[float] = 0.0  # This is the default loss factor for the Metered Sub-System (MSS) zone. The actual losses are calculated during the RT market.
