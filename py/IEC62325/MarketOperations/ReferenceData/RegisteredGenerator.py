...
# from IEC62325.MarketOperations.MktDomain import YesNo, FuelSource, RampCurveType, UnitRegulationKind, FlagTypeRMR, UnitType
# from IEC61970.Base.Domain import ActivePowerChangeRate, ActivePower, CostRate, Integer, CostBasis, CostPerHeatUnit, CostPerEnergyUnit
# from IEC61970.Base.Domain import PerCent, Float, String, DateTime
# from IEC62325.MarketOperations.MktDomain import YesNo, ActivePowerChangeRate, FuelSource, RampCurveType, UnitRegulationKind, FlagTypeRMR, UnitType
...
class RegisteredGenerator(RegisteredResource):
    ...
    def __init__(self):
        ...
        # Maximum Dependable Capacity (MNDC). Maximum Net Dependable Capacity is used in association with an RMR contract.
