...
class CongestionRevenueRight(Document):
	...
	def __init__(self):
		...
		self.crr_category = CRRCategoryType()  # CRR category represents 'PTP' for a point-to-point CRR, or 'NSR' for a Network Service Right.
		self.crr_type = CRRSegmentType()  # Type of the CRR, from the possible type definitions in the CRR System.
		self.hedge_type = CRRHedgeType()  # Hedge type Obligation or Option.
		self.time_of_use = TimeOfUse.ON  # Time of Use flag of the CRR - Peak (ON), Offpeak (OFF) or all 24 hours (24HR).
