...
class GovSteamFV2(TurbineGovernorDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.k: float = 1.0  # Fraction of the turbine power developed by turbine sections not involved in fast
        # valving (K)
        self.mw_base: float = 1.0  # Alternate Base used instead of Machine base in equipment model if necessary (
        # MWbase) (>0), Unit = MW
        self.r: float = 1.0  # (R)
