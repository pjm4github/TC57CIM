...
class PssIeee4B(PowerSystemStabilizerDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.ki11: PU = PU(1)  # Intermediate band first lead-lag blocks coefficient (K<sub>I11</sub>).  Typical Value = 1.
        self.ki17: PU = PU(1)  # Intermediate band first lead-lag blocks coefficient (K<sub>I17</sub>).  Typical Value = 1.
