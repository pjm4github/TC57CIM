...
class OverexcLimX2:
    ...
    def __init__(self) -> None:
        ...
        self.efd1: PU = PU(
            1.1)  # Low voltage or current point on the inverse time characteristic (EFD1). Typical Value = 1.1.

        # 	 * Mid voltage or current point on the inverse time characteristic
        # 	 * (EFD<sub>2</sub>).  Typical Value = 1.2.
        self.efd2: PU = PU(
            1.2)  # Mid voltage or current point on the inverse time characteristic (EFD2). Typical Value = 1.2.

        # 	 * High voltage or current point on the inverse time characteristic
        # 	 * (EFD<sub>3</sub>).  Typical Value = 1.5.
        self.efd3: PU = PU(
            1.5)  # High voltage or current point on the inverse time characteristic (EFD3). Typical Value = 1.5.
        ...
        # 	 * Typical Value = 1.05.
        self.efdrated: PU = PU(
            1.0)  # Rated field voltage if m=F or field current if m=T (EFDRATED). Typical Value = 1.05.
        ...
        self.t1: Seconds = Seconds(
            120)  # Time to trip the exciter at the low voltage or current point on the inverse time characteristic (
        # TIME1). Typical Value = 120.
        ...
        self.t2: Seconds = Seconds(
            40)  # Time to trip the exciter at the mid voltage or current point on the inverse time characteristic (
        # TIME2). Typical Value = 40.
        ...
        self.t3: Seconds = Seconds(
            15)  # Time to trip the exciter at the high voltage or current point on the inverse time characteristic (
        # TIME3). Typical Value = 15.
        # 	public Seconds t3;
