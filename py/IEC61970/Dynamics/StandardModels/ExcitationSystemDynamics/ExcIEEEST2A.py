...
class ExcIeeeSt2a(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.kc: float = 0.0  # Rectifier loading factor proportional to commutating reactance (K_EC). Typical Value = 1.82.
        ...
        self.te: Seconds = Seconds() # Exciter time constant, integration rate associated with exciter control (T_EE). Typical Value = 0.5.
        self.tf: Seconds = Seconds() # Excitation control system stabilizer time constant (T_EF). Typical Value = 1.
        self.uelin: bool = False  # UEL input (UELin). true = HV gate, false = add to error signal. Typical Value = true.
