...
class ExcAc6A(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.kc: PU = PU(
            .173)  # Rectifier loading factor proportional to commutating reactance (Kc).  Typical Value = 0.173.
        self.kd: PU = PU(
            1.91)  # Demagnetizing factor, a function of exciter alternator reactances (Kd).  Typical Value = 1.91.
        ...
        self.ks: PU = PU(
            0)  # Coefficient to allow different usage of the model-speed coefficient (Ks).  Typical Value = 0.
        self.seve1: float = 0.214  # Exciter saturation function value at the corresponding exciter voltage, Ve1,
        # back of commutating reactance (Se[Ve1]).  Typical Value = 0.214.
        self.seve2: float = 0.044  # Exciter saturation function value at the corresponding exciter voltage, Ve2,
        ...
        self.te: Seconds = Seconds(
            1)  # Exciter time constant, integration rate associated with exciter control (Te).  Typical Value = 1.
        ...
        self.ve1: PU = PU(
            7.4)  # Exciter alternator output voltages back of commutating reactance at which saturation is defined (
        # Ve1).  Typical Value = 7.4.
        self.ve2: PU = PU(
            5.55)  # Exciter alternator output voltages back of commutating reactance at which saturation is defined
        # (Ve2).  Typical Value = 5.55.
