...
class ExcAc2A:
    ...
    def __init__(self) -> None:
        ...
        self.kb: float = 0.0  # Second stage regulator gain (Kb) (>0). Exciter field current controller gain. Typical Value = 25.
        self.kb1: float = 0.0  # Second stage regulator gain (Kb1). It is exciter field current controller gain
        self.kc: float = 0.0  # Rectifier loading factor proportional to commutating reactance (Kc). Typical Value = 0.28.
        self.kd: float = 0.0  # Demagnetizing factor, a function of exciter alternator reactances (Kd). Typical Value = 0.35.
        ...
        self.se_ve1: float = 0.0  # Exciter saturation function value at the corresponding exciter voltage, Ve1 (Se[Ve1]). Typical Value = 0.037.
        self.se_ve2: float = 0.0  # Exciter saturation function value at the corresponding exciter voltage, Ve2 (Se[Ve2]). Typical Value = 0.012.
        ...
        self.te: Seconds = Seconds() # Exciter time constant, integration rate associated with exciter control (Te). Typical Value = 0.6.
        ...
        self.ve1: float = 0.0  # Exciter alternator output voltages back of commutating reactance at which saturation is defined (Ve1). Typical Value = 4.4.
        self.ve2: float = 0.0  # Exciter alternator output voltages back of commutating reactance at which saturation is defined (Ve2). Typical Value = 3.3.
