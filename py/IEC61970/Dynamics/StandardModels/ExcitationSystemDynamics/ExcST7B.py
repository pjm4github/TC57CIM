...
class ExcSt7B:
    ...
    def __init__(self) -> None:
        ...
        self.oelin: ExcST7BOELselectorKind = ExcST7BOELselectorKind.NO_OEL_INPUT # OEL input selector (OELin). Typical Value = noOELinput
        ...
        self.tg: Union[float, Any] = 1  # Feedback time constant of inner loop field voltage regulator (Tg). Typical Value = 1
        ...
        self.uelin: ExcST7BUELselectorKind = ExcST7BUELselectorKind.NO_UEL_INPUT  # UEL input selector (UELin). Typical Value = noUELinput
