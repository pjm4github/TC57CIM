...
class ExcSt4B:
    ...
    def __init__(self) -> None:
        """Constructor"""
        self.kc: float = 0.1  # Rectifier loading factor proportional to commutating reactance (Kc). Typical Value = 0.113
        ...
        self.lvgate: bool = False  # Selector (LVgate). true = LVgate is part of the block diagram. false = LVgate is not part of the block diagram. Typical Value = False
        ...
        self.uel: bool = False  # Selector (Uel). true = UEL is part of block diagram. false = UEL is not part of block diagram. Typical Value = False
