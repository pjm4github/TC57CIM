...
class ExcAc5A:
    ...
    def __init__(self) -> None:
        ...
        self.seefd1: float = 0.0  # Exciter saturation function value at the corresponding exciter voltage, Efd1 (S_E[Efd1]).  Typical Value = 0.86.
        self.seefd2: float = 0.0  # Exciter saturation function value at the corresponding exciter voltage, Efd2 (S_E[Efd2]).  Typical Value = 0.5.
        ...
        self.te: Seconds = Seconds() # Exciter time constant, integration rate associated with exciter control (Te).  Typical Value = 0.8.
