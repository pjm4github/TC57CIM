...
class ExcIeeeDc1A(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        ...
        """
        super().__init__()
        self.efd1: float = 0.0  # Exciter voltage at which exciter saturation is defined (E_FD1). Typical Value = 3.1.
        self.efd2: float = 0.0  # Exciter voltage at which exciter saturation is defined (E_FD2). Typical Value = 2.3.
        ...
        self.vrmax: float = 0.0  # Maximum voltage regulator output (V_RMAX).  Typical Value = 1.
        self.vrmin: float = 0.0  # Minimum voltage regulator output (V_RMIN).  Typical Value = -0.9.
