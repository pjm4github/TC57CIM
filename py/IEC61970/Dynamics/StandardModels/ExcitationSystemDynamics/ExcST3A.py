...
class ExcSt3A(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.kc: PU = PU(
            1.1)  # Rectifier loading factor proportional to commutating reactance (Kc).  Typical Value = 1.1.
        ...
        self.ks1: PU = PU(
            0)  # Coefficient to allow different usage of the model-speed coefficient (Ks1). Typical Value = 0.
