...
class ExcElin2(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.seve1: float = 1.0  # Exciter saturation function value at the corresponding exciter voltage, Ve1, back of commutating reactance (Se[Ve1]).  Typical Value = 0.
        self.seve2: float = 1.0  # Exciter saturation function value at the corresponding exciter voltage, Ve2, back of commutating reactance (Se[Ve2]).  Typical Value = 1.
        self.tb1: Seconds = Seconds() # Voltage controller derivative washout time constant (Tb1).  Typical Value = 12.45.
        ...
        self.ve1: float = 1.0  # Exciter alternator output voltages back of commutating reactance at which saturation is defined (Ve1).  Typical Value = 3.
        self.ve2: float = 1.0  # Exciter alternator output voltages back of commutating reactance at which saturation is defined (Ve2).  Typical Value = 0.
