...
class ExcIeeeAc8B(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.kc: float = 0.0  # Rectifier loading factor proportional to commutating reactance (K_C). Typical Value =
        # 0.55.
        self.kd: float = 0.0  # Demagnetizing factor, a function of exciter alternator reactances (K_D). Typical
        # Value = 1.1.
        ...
        self.seve1: float = 0.0  # Exciter saturation function value at the corresponding exciter voltage, V_E1,
        # back of commutating reactance (S_E[V_E1]). Typical Value = 0.3.
        self.seve2: float = 0.0  # Exciter saturation function value at the corresponding exciter voltage, V_E2,
        # back of commutating reactance (S_E[V_E2]). Typical Value = 3.
