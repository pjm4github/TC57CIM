...
class ExcAc1A(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.hvlv_gates: bool = True  # Indicates if both HV gate and LV gate are active (HVLVgates). True = gates
        # are used, False = gates are not used. Typical Value = True.
        self.ka: float = 400.0  # Voltage regulator gain (Ka). Typical Value = 400.
        self.kc: float = 0.2  # Rectifier loading factor proportional to commutating reactance (Kc). Typical Value =
        # 0.2.
        self.kd: float = 0.38  # Demagnetizing factor, a function of exciter alternator reactances (Kd). Typical
        # Value = 0.38.
        ...
        # Value = 0.
        self.se_ve1: float = 0.1  # Exciter saturation function value at the corresponding exciter voltage, Ve1,
        # back of commutating reactance (Se[Ve1]). Typical Value = 0.1.
        self.se_ve2: float = 0.03  # Exciter saturation function value at the corresponding exciter voltage, Ve2,
        ...
        self.te: Seconds = Seconds(
            0.8)  # Exciter time constant, integration rate associated with exciter control (Te). Typical Value = 0.8.
        ...
        self.ve1: float = 4.18  # Exciter alternator output voltages back of commutating reactance at which
        # saturation is defined (Ve1). Typical Value = 4.18.
        self.ve2: float = 3.14  # Exciter alternator output voltages back of commutating reactance at which
