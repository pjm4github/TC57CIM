...
class ExcIeeeAc1A(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.kc: Optional[PU] = PU()  # Rectifier loading factor proportional to commutating reactance (K_C), Typical Value = 0.2
        self.kd: Optional[PU] = PU()  # Demagnetizing factor, a function of exciter alternator reactances (K_D), Typical Value = 0.38
        ...
        self.seve1: Optional[float] = 1.0  # Exciter saturation function value at the corresponding exciter voltage, V_E1 (S_E[V_E1]), Typical Value = 0.1
        self.seve2: Optional[float] = 1.0  # Exciter saturation function value at the corresponding exciter voltage, V_E2 (S_E[V_E2]), Typical Value = 0.03
        ...
        self.te: Optional[Seconds] = Seconds()  # Exciter time constant, integration rate associated with exciter control (T_E), Typical Value = 0.8
        ...
        self.ve1: Optional[PU] = PU()  # Exciter alternator output voltages back of commutating reactance at which saturation is defined (V_E1), Typical Value = 4.18
        self.ve2: Optional[PU] = PU()  # Exciter alternator output voltages back of commutating reactance at which saturation is defined (V_E2), Typical Value = 3.14
        self.vrmax: Optional[PU] = PU()  # Maximum voltage regulator outputs (V_RMAX), Typical Value = 6.03
        self.vrmin: Optional[PU] = PU()  # Minimum voltage regulator outputs (V_RMIN), Typical Value = -5.43
