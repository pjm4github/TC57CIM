...
class ExcAvr7(ExcitationSystemDynamics):
    ...
    def __init__(self) -> None:
        ...
        self.t1: Any = 0.05  # Lead time constant (T1).  Typical Value = 0.05.
        self.t2: Any = 0.1  # Lag time constant (T2).  Typical Value = 0.1.
        self.t3: Any = 0.1  # Lead time constant (T3).  Typical Value = 0.1.
        self.t4: Any = 0.1  # Lag time constant (T4).  Typical Value = 0.1.
        self.t5: Any = 0.1  # Lead time constant (T5).  Typical Value = 0.1.
        self.t6: Any = 0.1  # Lag time constant (T6).  Typical Value = 0.1.
