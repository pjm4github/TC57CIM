...
class DiagramObject:
    ...
    def __init__(self) -> None:
        ...
        self.is_polygon: bool = True    # Defines whether the diagram objects points define the boundaries of a polygon
        self.offset_x: float = 1.0      # The offset in the X direction
        self.offset_y: float = 1.0      # The offset in the Y direction
