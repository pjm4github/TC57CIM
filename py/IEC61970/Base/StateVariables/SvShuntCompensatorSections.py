...
class SvShuntCompensatorSections(StateVariable):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.sectionsOptional[float] = 1.0  # The number of sections in service as a continuous variable. To get integer value, scale with ShuntCompensator.b_per_section.
