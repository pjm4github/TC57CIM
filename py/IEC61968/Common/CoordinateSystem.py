...
class CoordinateSystem(IdentifiedObject):
    ...
    #  * An example would be the European Petroleum Survey Group (EPSG) code1 for a
    ...
    #  * EPSG code1 (a full list of codes can be found at the EPSG Registry website http:
    ...
    #  * uom:EPSG::4236.
    #  * A profile should limit this code1 to a set of allowed URNs agreed to by all
