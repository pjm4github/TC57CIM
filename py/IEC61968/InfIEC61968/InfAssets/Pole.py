...
from IEC61968.InfIEC61968.InfAssets.PolePreservativeKind import PolePreservativeKind
...
class Pole(Structure):
    def __init__(self):
        ...
        self.breast_block = True  # True if a block of material has been attached to base of pole in ground for
        # stability
        ...
        self.preservative_kind = PolePreservativeKind.CREOSOTE  # Kind of preservative for this pole
        self.species_type = ""  # Pole species
        self.treated_date_time = DateTime()  # Date and time pole was last treated with preservative
        self.treatment_kind = PoleTreatmentKind.GRAY_STAIN  # Kind of treatment for this pole
