...
from IEC61968.Assets.StructureSupport import StructureSupport
from IEC61968.InfIEC61968.InfAssets.StructureMaterialKind import StructureMaterialKind
...
class Structure(AssetContainer):
    ...
    def __init__(self):
        ...
        self.material_kind = StructureMaterialKind.WOOD  # Material this structure is made of.
