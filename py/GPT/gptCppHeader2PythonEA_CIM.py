    ...
    try:
        chat_completion = client.chat.completions.create(
            messages=[
                {
                    "role": "system",
                    "content": "Given this Cpp Header, convert this code1 to python, using snake_case methods and "
                               "attributes, include the original comments, use the Enum library where appropriate. "
...
if __name__ == "__main__":
    ...
    directory_path = f"{os.path.expanduser('~')}/Documents/Git/GitHub/TC57CIM/py/IEC62325/InfIEC62325/InfDomain/"
            ...
            if filename.endswith(".h"):
                ...
                if os.path.isfile(file_path):
                    ...
                    if converted_code:
                        ...
                        new_filename = filename.replace('.h', '.py')
